...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_2.setTitle(_translate("MainWindow", "血清指数参考值"))
        self.label.setText(_translate("MainWindow", "H (血红蛋白):"))
        self.label_2.setText(_translate("MainWindow", "I (黄疸):        "))
        self.label_3.setText(_translate("MainWindow", "L (乳糜):       "))
        self.groupBox_3.setTitle(_translate("MainWindow", "血清指数分析结果"))
        self.label_4.setText(_translate("MainWindow", "H (血红蛋白):"))
        self.label_6.setText(_translate("MainWindow", "I (黄疸):        "))
        self.label_5.setText(_translate("MainWindow", "L (乳糜):       "))
        ...
        self.groupBox_5.setTitle(_translate("MainWindow", "血清指数参考值"))
        self.label_8.setText(_translate("MainWindow", "H (血红蛋白):"))
        self.label_9.setText(_translate("MainWindow", "I (黄疸):        "))
        self.label_10.setText(_translate("MainWindow", "L (乳糜):       "))
        self.groupBox_6.setTitle(_translate("MainWindow", "血清指数分析结果"))
        self.label_11.setText(_translate("MainWindow", "H (血红蛋白):"))
        self.label_12.setText(_translate("MainWindow", "I (黄疸):        "))
        self.label_13.setText(_translate("MainWindow", "L (乳糜):       "))
        ...
        self.groupBox_8.setTitle(_translate("MainWindow", "血清指数参考值"))
        self.label_15.setText(_translate("MainWindow", "H (血红蛋白):"))
        self.label_16.setText(_translate("MainWindow", "I (黄疸):        "))
        self.label_17.setText(_translate("MainWindow", "L (乳糜):       "))
        self.groupBox_9.setTitle(_translate("MainWindow", "血清指数分析结果"))
        self.label_18.setText(_translate("MainWindow", "H (血红蛋白):"))
        self.label_19.setText(_translate("MainWindow", "I (黄疸):        "))
        self.label_20.setText(_translate("MainWindow", "L (乳糜):       "))
